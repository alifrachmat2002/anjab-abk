    ...
    ->group(function () {
        Route::prefix('ajuan')
            ...
            ->group(function () {
                ...
                Route::get('/{ajuan}/jabatan/{jabatan}', [AnjabController::class, 'anjabShowJabatan'])->name('jabatan.show');
                Route::get('/{ajuan}/jabatan/{jabatan}/edit/1', [AnjabController::class, 'anjabEditJabatan1'])->name('jabatan.edit.1');
                Route::put('/{ajuan}/jabatan/{jabatan}/update/1', [AnjabController::class, 'anjabUpdateJabatan1'])->name('jabatan.update.1');
                Route::get('/{ajuan}/jabatan/{jabatan}/edit/2', [AnjabController::class, 'anjabEditJabatan2'])->name('jabatan.edit.2');
                Route::put('/{ajuan}/jabatan/{jabatan}/update/2', [AnjabController::class, 'anjabUpdateJabatan2'])->name('jabatan.update.2');
...
Route::prefix('/abk/ajuan')->name('abk.')->group(function () {
    Route::get('/', [AbkController::class, 'index'])->name('ajuans');
    Route::get('/{abk}', [AbkController::class, 'showAjuan'])->name('ajuan.show');
    Route::get('/{abk}/unit/{unit_kerja}', [AbkController::class, 'showUnitKerja'])->name('unitkerja.show');
    Route::get('/{abk}/unit/{unit_kerja}/jabatan/{abk_jabatan}', [AbkController::class, 'showJabatan'])->name('jabatan.show');
...
Route::prefix('/laporan')
    ...
    ->group(function () {
        ...
        Route::get('/anjab/{tahun}/{anjab}/laporan/download', [LaporanController::class, 'downloadLaporanAnjab'])->name('anjab.download');
